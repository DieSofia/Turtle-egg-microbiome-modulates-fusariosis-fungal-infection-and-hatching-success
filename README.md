...
1. Publication_code -> code ready to be run in the R environment. I have tried to comment and explain what we have done; however, if something is unclear, don't hesitate to contact me.
2. ANCOM updated code -> In this folder, you will find the code you need to load for Ancom analyses.
